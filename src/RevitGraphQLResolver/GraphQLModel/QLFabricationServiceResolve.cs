...
namespace RevitGraphQLResolver.GraphQLModel
{
    public class QLFabricationServiceResolve : QLFabricationService
    {
        ...
        //                qlFabricationParts.Add(new QLFabricationPartResolve(aFabPart, qlFabricationPartsField));
        //            }
        //        }
        //    }
        ...
        public QLFabricationServiceResolve(FabricationService _fabService, object aFieldOrContext)
        {
            ...
            var qlFabricationPartsField = GraphQlHelpers.GetFieldFromFieldOrContext(aFieldOrContext, "qlFabricationParts");
            if (qlFabricationPartsField != null)
            {
                Autodesk.Revit.DB.Document _doc = ResolverEntry.Doc;
